...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # Read the dog names from a file into a dictionary
    with open(dogfile, "r") as file:
        for line in file:
            ...
            if dog_name not in dognames_dic:
                ...
                print(f"Warning: Duplicate dog name {dog_name} in {dogfile}")
      # Update results_dic with information whether labels are dogs
    for key, value in results_dic.items():
        ...
        classifier_label_is_dog = 1 if value[1] in dognames_dic else 0
        
        # Extend the list with these new information
